...
$beitrag = $pdo->prepare("SELECT * FROM beitraege WHERE id = ?");
...
$aendern = $pdo->prepare("UPDATE beitraege SET inhalt = :inhalt_neu, aenderung_mod = 1 WHERE id = :id");
$aendern->bindParam(':inhalt_neu', utf8_decode($inhalt_neu));
