...
$stmt3 = $pdo->prepare("UPDATE freundesliste SET bestaetigt = 1 WHERE user = :user_id AND freund = :friend_id");
...
<h2><center>Die Freundschaft-Anfrage wurde Bestätigt !<br><br><hr><a class="btn_green" href="<?=URL;?>">Gehe zur Webseite zurück</a></center></h2>
